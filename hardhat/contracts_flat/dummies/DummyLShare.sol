...
contract DummyLShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _treasuryFund) public ERC20("Dummy Libra Finance SHARE", "Dummy LSHARE") {
