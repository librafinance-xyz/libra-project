...
export async function prepare(thisObject: any, contracts: any) {
  ...
  thisObject.taxcollector = thisObject.signers[4]
...
export async function deploy(thisObject: { [x: string]: { deployed: () => any } }, contracts: { [x: string]: any }) {
  for (let i in contracts) {
    let contract = contracts[i]
...
//   thisObject: {
//     [x: string]: { mint: (arg0: any) => any }
//     factory: { createPair: (arg0: any, arg1: any) => any }
//     UniswapV2Pair: { attach: (arg0: any) => any }
//     alice: { address: any }
//   },
//   name: string | number,
