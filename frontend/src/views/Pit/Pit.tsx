...
import { BOND_REDEEM_PRICE, BOND_REDEEM_PRICE_BN } from '../../libra-finance/constants';
            ...
            <StyledBond>
              ...
              <StyledCardWrapper>
                <ExchangeCard
                  ...
                  disabledDescription={!isBondRedeemable ? `Enabled when LIBRA > ${BOND_REDEEM_PRICE}ASTR` : null}
                />
              </StyledCardWrapper>
            </StyledBond>
          </>
