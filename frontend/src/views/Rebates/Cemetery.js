...
const Cemetery = () => {
  ...
  const [claimablelibra, setClaimablelibra] = useState(0);
                ...
                <Grid container justify="center" spacing={3}>
                  <Grid item xs={12} md={3} lg={3} className={classes.gridItem}>
                    <Card style={{ height: 'auto' }}>
                      <CardContent align="center">
                        <Typography variant="h5">LIBRA Vesting</Typography>
                        <Typography variant="h6">{vested.toFixed(4)} Total Vested</Typography>
                        <Typography variant="h6">{claimablelibra.toFixed(4)} Claimable</Typography>
                        <Button
                          color="primary"
                          size="small"
                          variant="contained"
