...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'LIBRA-WASTR-LP': ['0x86DbDb6BfB6bB9137Bf1845611238AfA21A88149', 18], //DUMMY
      'LSHARE-WASTR-LP': ['0xd8076c94850859330A194EA48F40B72f3202569A', 18], //DUMMY
      LIBRA: ['0x389C7DD67db2466c9d6ad3160D5799E6422326D2', 18], // DUMMY
      LBOND: ['0x5b9B58E4D1aEd66adF38D81edf0D3b01FC001fFB', 18], // DUMMY
      LSHARE: ['0xF5041E1F129c32E35008A7cAEEB6f458c5974662', 18], // DUMMY
    },
